...
def test_run_format_verbose_shows_file_being_formatted(tmp_path, capsys):
    """In verbose mode, run_format prints the file being formatted."""
...
def test_run_format_default_mode_no_file_info_shown(tmp_path, capsys):
    """In default mode, run_format does not print the file being formatted."""
    from gd_tools.verbosity import Verbosity, set_verbosity
