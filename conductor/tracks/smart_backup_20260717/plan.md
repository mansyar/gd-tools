...
- [ ] Task: Write failing unit tests for smart backup behavior in `tests/unit/test_init.py`
...
- [ ] Task: Implement smart backup logic in `install_coverage_addon` (`src/gd_tools/init.py`)
